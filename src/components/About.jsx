...
const About = () => {
    return (
        <section id="about" style={{ padding: '5rem 1rem', background: '#f8fafc' }}>
            <div className="container">
                ...
                >
                    <h2 style={{ fontSize: 'clamp(2rem, 5vw, 3rem)', fontWeight: 800, color: '#0f172a', marginBottom: '0.5rem' }}>
                        About Me
                    </h2>
                    ...
                    >
                        {[
                            ...
                            >
                                ...
                                <h3 style={{ fontWeight: 700, fontSize: '1.125rem', marginBottom: '0.5rem', color: '#0f172a' }}>{item.title}</h3>
                                <p style={{ color: '#475569', fontSize: '0.875rem' }}>{item.desc}</p>
                                {item.sub && <p style={{ color: '#475569', fontSize: '0.875rem' }}>{item.sub}</p>}
                            </motion.div>
                        ))}
                    </motion.div>
                </div>
